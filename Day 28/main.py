...
timer_label = Label(text="Timer", font=(
    FONT_NAME, 25, "bold"), bg=YELLOW, fg=GREEN)
timer_label.grid(column=2, row=1)

start_label = Button(text="Start", font=(
    FONT_NAME, 15, "bold"), highlightthickness=0, command=start_timer)
start_label.grid(column=1, row=3)

reset_label = Button(text="Reset", font=(
    FONT_NAME, 15, "bold"), highlightthickness=0, command=reset_timer)
reset_label.grid(column=3, row=3)

checkmark_label = Label(text="✓", font=(
    FONT_NAME, 15, "bold"), fg=GREEN, bg=YELLOW, highlightthickness=0)
